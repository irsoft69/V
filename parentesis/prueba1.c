...
string main__Foo_str(main__Foo x); // auto
string indent_main__Foo_str(main__Foo x, int indent_count); // auto
...
string main__Foo_str(main__Foo x) { return indent_main__Foo_str(x, 0);}
string indent_main__Foo_str(main__Foo x, int indent_count) {
	main__Foo *it = &x;
...
static void main__main() {
	main__Foo* f = (main__Foo*)memdup(&(main__Foo){.x = 10,}, sizeof(main__Foo));
	f = (main__Foo*)memdup(&(main__Foo){.x = 20,}, sizeof(main__Foo));
	main__Foo g = (main__Foo){.x = 10,};
	g = (main__Foo){.x = 20,};
	println(main__Foo_str(*f));
	println(main__Foo_str(g));
}

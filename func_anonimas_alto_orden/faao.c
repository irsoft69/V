...
static int run(int value, int (*op)(int));
// variadic structs
struct varg_voidptr {
	int len;
	voidptr args[0];
...
static int anon_298_7_7(int n) {
	return n + n;
}

static int anon_452_7_7(int n) {
	return n + n;
}
...
int main(int ___argc, char** ___argv){
	_vinit();
println(int_str(run(5, sqr)));
int (*double_fn) (int n) = &anon_298_7_7;
println(int_str(run(5, double_fn)));
int res = run(5, &anon_452_7_7);
println(int_str(res));
	return 0;
}
